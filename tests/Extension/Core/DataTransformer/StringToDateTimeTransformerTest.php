...
class StringToDateTimeTransformerTest extends DateTimeTestCase
{
    ...
    {
        $transformer = new StringToDateTimeTransformer('America/New_York', 'Asia/Hong_Kong', 'Y-m-d H:i:s');
    ...
    public function testTransformExpectsString()
    {
        $transformer = new StringToDateTimeTransformer();
    ...
    public function testTransformExpectsValidDateString()
    {
        $transformer = new StringToDateTimeTransformer();
    ...
    public function testTransformWithNonExistingDate()
    {
        $transformer = new StringToDateTimeTransformer();
