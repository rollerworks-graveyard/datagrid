...
sys.path.append(os.path.abspath('../_themes/rollerworks/_exts'))
...
project = u'RollerworksDatagrid Documentation'
copyright = ''
...
api_url = 'http://rollerworks.github.io/datagrid/doc/%s'
...
html_title = 'RollerworksDatagrid Documentation'
...
htmlhelp_basename = 'RollerworksDatagridDoc'
...
latex_documents = [
  ('index', 'RollerworksDatagrid.tex', u'RollerworksDatagrid Documentation',
...
man_pages = [
    ('index', 'rollerworksdatagrid', u'RollerworksDatagrid Documentation',
     [u'Sebastiaan Stok'], 1)
]
...
texinfo_documents = [
  ('index', 'RollerworksDatagrid', u'RollerworksDatagrid Documentation',
   u'Sebastiaan Stok', 'RollerworksDatagrid', '',
   'Miscellaneous'),
]
